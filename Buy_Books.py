...
class BuyBooks:
    ...
    def buy_gui(self):
        ...
        self.style.configure("mystyle.Treeview", font=('Ariel', 9, 'bold'),background="yellow", foreground="white")
        self.style.configure("mystyle.Treeview.Heading", font=('Ariel', 10, 'bold'),background="orange",fg='white')
        ...
        self.back = Button(self.buy_dis, text="Back", command=self.buy_dis.destroy, bg='green', font=('Ariel', 9, 'bold'))
    ...
    def select(self):
        ...
        if user_chosen == '':
            ...
            self.search_ent = ttk.Combobox(self.buy_dis, text='Keyword', font=('Ariel', 13, 'bold'), width=16,
                                           values=values)
            self.search_ent.place(x=230, y=350)
    ...
    def bills(self):
        ...
        if discount == '':
            ...
            self.bill_button = Button(self.buy_dis, bg='blue', fg='white', command=self.bill_gui, text='Add to Bills',
                                      font=('Ariel', 11, 'bold'))
    ...
    def bill_gui(self):
        ...
        self.lbl_ = Label(self.bill_dis, text='ORIENTAL BOOK HOUSE', fg='maroon', bg='sky blue2',
                          font=('Ariel', 15, 'bold'))
        ...
        self.st_button = Button(self.bill_dis, bg='black', fg='white', text='Store', command=self.billdb,
                                font=('Ariel', 10, 'bold'))
