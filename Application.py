...
class Guis:
    ...
    def reg_screen(self):
        try:
            ...
            self.btn01 = Button(self.reges, text='     Register     ', bg='black', fg='white',
                                font=('Ariel', 13, 'bold'),
    ...
    def aft_log(self):
        ...
        self.logname = Label(self.window, text=self.data_base.get_name(username1, password1),
                             font=('Times New Roman', 12, 'italic'), bg='darkslategray1', fg='blue')
    ...
    def send_mail(self, email):
        ...
        try:
            ...
            message = "Subject: {} {}".format('Hello there!',
