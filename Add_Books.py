...
class AddBooks:
    ...
    def add_gui(self):
        try:
            ...
            self.ad_book = Button(self.display, text='Add', command=self.addbooks_hand, bg='black', fg='white', width=6,
                                  font=('Ariel', 11, 'bold'))
            self.ad_book.place(x=140, y=570)

            self.up_book = Button(self.display, text='Update', bg='black', fg='white', command=self.update_item,
                                  font=('Ariel', 11, 'bold'))
            self.up_book.place(x=240, y=570)

            self.del_book = Button(self.display, text='Delete', bg='black', fg='white', command=self.delete_item,
                                   font=('Ariel', 11, 'bold'))
            ...
            self.add_tree = ttk.Treeview(self.display, style="mystyle.Treeview",
                                         column=('n', 'w', 'p', 'm', 'c', 'e', 'r'), height=17)
            ...
            self.ser_book = Button(self.display, bg='yellow', text='Search', font=('Ariel', 10, 'bold'),
            ...
            self.exit = Button(self.display, text='Delete', bg='black', fg='white', command=self.delete_item,
                               font=('Ariel', 11, 'bold'))
            self.del_book.place(x=340, y=570)

            self.back1 = Button(self.display, text="Mainscreen", command=self.backbut, bg='yellow',
                                font=('Ariel', 9, 'bold'))
